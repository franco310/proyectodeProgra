...
public class rkardex {
    ...
    public rkardex(int idKardex, int precio_compra, int precio_venta, int stok_anterior, int stock_actual, int cantidad, int idArticulo, int idEntrada, int idSalida) {
